                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('users.index', array_diff_key(request()->query(), ['rol' => ''])) }}">
                                    Todos los roles
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('users.index', array_merge(request()->query(), ['rol' => 'cliente'])) }}">
                                    Clientes
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('users.index', array_merge(request()->query(), ['rol' => 'tecnico'])) }}">
                                    Técnicos
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('users.index', array_merge(request()->query(), ['rol' => 'administrador'])) }}">
                                    Administradores
                                </a>
                            </li>
                            ...
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('users.index', array_merge(request()->query(), ['rol' => 'super_admin'])) }}">
                                    Super Admins
                                </a>
                            </li>
                            @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <!-- Super admin no editable por no super_admins -->
                                            <button class="btn btn-outline-warning"
                                                title="No puedes editar a un Super Admin" disabled>
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            @else
                                            <!-- Todos los demás usuarios editables -->
                                            ...
                                            <button type="button" class="btn btn-outline-danger" title="Eliminar"
                                                data-bs-toggle="modal" data-bs-target="#modalEliminar{{ $user->id }}"
                                                @if(auth()->id() == $user->id ||
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>¿Estás seguro de eliminar al usuario
                                                            <strong>{{ $user->name }}</strong>?
                                                        </p>
                                                        ...
                                                        <ul class="text-muted">
                                                            ...
                                                            <li>Registrado: {{ $user->created_at->format('d/m/Y') }}
                                                            </li>
                                                        </ul>
                                                    </div>

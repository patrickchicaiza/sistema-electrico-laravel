                                    ...
                                    <div class="timeline-content">
                                        <div class="d-flex justify-content-between">
                                            <h6 class="mb-1">
                                                ...
                                                <span class="badge bg-{{ $actividad->prioridad == 'alta' ? 'danger' : 'secondary' }}">
                                                    {{ $actividad->prioridad }}
                                                </span>
                                            </h6>
                            ...
                            <div class="row text-center">
                                <div class="col-6">
                                    <div class="border rounded p-2">
                                        <div class="h5 mb-1">{{ round(($estados['resuelto'] / max(1, $total)) * 100) }}%</div>
                        ...
                        <div class="card-body">
                            @php
                                $tecnicos = \App\Models\User::conRol('tecnico')
                                    ->withCount(['reportesComoTecnico as resueltos' => function($query) {
                                ...
                                <div class="list-group-item border-0 px-0 py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">
                                                {{ $tecnico->reportesComoTecnico()->whereIn('estado', ['asignado', 'en_proceso'])->count() }} activos
                                            </small>
                                        </div>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                <button class="btn btn-outline-info text-start" data-bs-toggle="modal" data-bs-target="#modalReportes">

                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0">{{ auth()->user()->reportes_activos_count }}/3</h2>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0">
                                        {{ auth()->user()->reportesComoCliente()->where('estado', 'pendiente')->count() }}
                                    </h2>
                                </div>
